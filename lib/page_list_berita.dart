...
import 'package:coba/detail_berita.dart';
...
class _PageListBeritaState extends State<PageListBerita> {
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.get(Uri.parse('http://10.127.210.200/beritaDb/getBerita.php'));
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      'http://10.126.70.149/beritaDb/gambar_berita/${data?.gambarBerita}',
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
